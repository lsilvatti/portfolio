...
/**
 * Local SVG icon definitions.
 * These take priority over lucide-react when the Icon component resolves a name.
 * Add or override any icon here — the SVG content is rendered inside a 24×24 viewBox wrapper.
 */
